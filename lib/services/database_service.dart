...
class DatabaseService {
  ...
  Future togglingGroupJoin(String groupId, String groupName, String userName) async {
    ...
    Map<dynamic,dynamic>groupsMap= userDocSnapshot.data();
    List<dynamic> groups = groupsMap['groups'];
  ...
  Future<bool> isUserJoined(String groupId, String groupName, String userName) async {
    ...
    DocumentReference userDocRef = userCollection.doc(uid);
    DocumentSnapshot userDocSnapshot = await userDocRef.get();
    Map<dynamic,dynamic> groupMap= userDocSnapshot.data();

  //  List<dynamic> groups = await userDocSnapshot.data['groups'];
    List<dynamic> groups = groupMap['groups'];
